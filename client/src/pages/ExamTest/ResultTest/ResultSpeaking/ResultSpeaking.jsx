...
const ResultTestSpeaking = ({ numberLession }) => {
	...
	useEffect(() => {
		...
		setSubQuestionsPartFour(
			SpeakingPartFour?.questions[RES_DATA].subQuestion
		);
		...
		setSubQuestionsThree(
			SpeakingPartThree?.questions[RES_DATA].subQuestion
		);
	...
	const renderPartFour = () => (
		<FrameReadingResult defaultWidth={true}>
			<div className="flex flex-col gap-6">
				<div className="font-bold text-[17px]">
					{contentPartFour && contentPartFour.content}
				</div>
